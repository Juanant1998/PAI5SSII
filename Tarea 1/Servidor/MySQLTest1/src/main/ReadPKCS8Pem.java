...
//        pkcs8Pem = pkcs8Pem.replaceAll("\\s+","");
        ...
        String str_priv = Base64.getEncoder().encodeToString(byte_privkey);

        System.out.println(str_priv);
    }
