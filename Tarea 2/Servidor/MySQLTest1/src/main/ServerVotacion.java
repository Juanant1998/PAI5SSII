...
public class ServerVotacion {
	...
	public static void main(final String[] args) throws Exception {
		...
		SSLServerSocket serverSocket = (SSLServerSocket) socketFactory.createServerSocket(8091);
		serverSocket.setEnabledProtocols(ServerVotacion.protocols);
		serverSocket.setEnabledCipherSuites(ServerVotacion.cipher_suites);
		String tokenValido = "12345"; //TODO: Recuperar esto de la base de datos
		while (true) {
			String signature = "";
			String message = "";
			RSAPublicKey rsaPublicKey = (RSAPublicKey) ServerVotacion.getPublicKey();
